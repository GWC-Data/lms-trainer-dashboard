...
export default function Trainees() {
    ...
    const filtered = useMemo(() => trainees.filter((t) => {
        ...
        if (batchFilter !== ALL && t.batchId !== batchFilter)
            return false;
        if (modeFilter !== ALL && batchById(t.batchId)?.mode !== modeFilter)
            return false;
