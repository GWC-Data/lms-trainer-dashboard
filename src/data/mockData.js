...
function generateTrainees(batchId, courseId, prefix, count) {
...
function generateAttendanceRows(batchId, lateIndex, absentIndex, lateRemark) {
...
export function totalTraineesForCourse(courseId) {
...
export function avgProgressForCourse(courseId) {
...
export function nextSessionForCourse(courseId) {
    const courseBatches = batchesForCourse(courseId);
...
export function traineeModuleProgress(trainee) {
